...
public class UniversalVideoView extends SurfaceView
    ...
    public void start() {
        ...
        if (isInPlaybackState()) {
            Log.e("videoView", "播放" + mCurrentState);
            if (mCurrentState == STATE_PLAYBACK_COMPLETED) {
                mMediaPlayer.seekTo(mMediaController.getNewPosition());
            }
            mMediaPlayer.start();
